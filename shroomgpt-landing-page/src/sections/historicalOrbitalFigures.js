...
export const HISTORICAL_ORBITAL_FIGURES = [
  {
    ...
    substance: "LSD",
    contribution:
      "Molecular biologist who co-discovered the structure of DNA. He described using LSD to help visualize molecular geometries that conventional thinking couldn't reach — thinking, he said, in entirely new dimensions.",
    quote:
      "I began to see how a helix could carry the information life depends on — if the mind was free to fold in three dimensions, not on the page.",
  },
  {
    ...
    quote: "Hallucinations are useful to investigate the nature of consciousness.",
  },
  {
    name: "Kary Mullis",
    dates: "1944 — 2019",
    ...
    quote: "Would I have invented PCR if I hadn't taken LSD? I seriously doubt it.",
  },
  {
    name: "Carl Sagan",
    dates: "1934 — 1996",
